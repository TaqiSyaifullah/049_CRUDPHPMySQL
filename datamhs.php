   ...
   <div class="mx-auto">
       <div class="card">
            ...
            <div class="card-body">
                ...
                <?php
                    header("refresh:3;url=datamhs.php");//3 : detik
                }
                ?>
                <?php
                if ($sukses) {
                    ...
                    <tbody>
                        ...
                        ?>
                            <tr>
                                ...
                                <td scope="row">
                                    <a href="datamhs.php?op=edit&id=<?php echo $id ?>"><button type="button" class="btn text-white btn-danger">Edit</button></a>
                                    <a href="datamhs.php?op=delete&id=<?php echo $id?>" onclick="return confirm('Apakah anda yakin ingin delete data?')"><button type="button" class="btn btn-success">Delete</button></a>            
                                </td>
                            </tr>
                        <?php
                        }
